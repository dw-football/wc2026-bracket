...
//            h2hAdvanceProb(a, b, matchNo) -> number }  (distributions sorted desc)
// ----------------------------------------------------------------------------

export function makeKoSlotDist(opts) {
  const { bracket, eloByCode, koLambda, koVenueCountry, r32Occupant, koWinner } = opts;
  ...
  return { slotDist, winnerDist, h2hAdvanceProb };
}
